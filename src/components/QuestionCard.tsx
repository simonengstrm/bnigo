...
export default function QuestionCard( { question, bingoCheck }: { question: Question, bingoCheck : () => void } ) {
  ...
  return (
    <div onClick={clickHandler} className={"p-2 mb-2 h-48 justify-center flex text-center place-items-center shadow-2xl hover:scale-105 transition-transform ease-linear " + (isClicked ? "bg-green-500" : "bg-white")}>
